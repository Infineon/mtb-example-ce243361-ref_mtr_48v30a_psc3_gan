...
#if  !defined(MOTOR_CTRL_MOTOR1_ENABLED)
...
#define TEMP_SENSOR_OFFSET (0.5f)       // MCP9700AT-E/LT: 500mV    MAX6612: 400mV is 0 ℃
#define TEMP_SENSOR_SCALE  (0.010f)     // MCP9700AT-E/LT: 10mV/℃   MAX6612: 19.53mV/℃

#if (MOTOR_CTRL_MOTOR1_ENABLED)
#define ACTIVE_TEMP_SENSOR_M1  true        // Active IC (e.g. MCP9700T-E/TT) vs Passive NTC (e.g. NCP18WF104J03RB)
#define TEMP_SENSOR_OFFSET_M1 (0.5f)       // MCP9700AT-E/LT: 500mV    MAX6612: 400mV is 0 ℃
#define TEMP_SENSOR_SCALE_M1  (0.010f)     // MCP9700AT-E/LT: 10mV/℃   MAX6612: 19.53mV/℃
#endif
...
#define KIT_ID                (0x0010UL)    // For GUI's recognition of HW

/* CPU load calculation configuration */
#define CPU_LOAD_CALC_ENABLED           (0U)      // Set to (0U) to disable CPU load measurement
