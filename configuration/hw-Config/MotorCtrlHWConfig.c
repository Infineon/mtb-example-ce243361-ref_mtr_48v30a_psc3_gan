...
static void* const ADC_Result_Regs_MUXA[ADC_SEQ_MAX][ADC_SAMP_PER_SEQ_MAX] = \
        {{ADC_RESULT_ADDR(ADC_SAMP_IU_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_IW_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_IDCLINK_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_TEMP_CHAN_IDX), ADC_SAMP_UNUSED},
         {ADC_RESULT_ADDR(ADC_SAMP_IV_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_VBUS_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_VPOT_CHAN_IDX), ADC_SAMP_UNUSED, ADC_SAMP_UNUSED}};

static const uint8_t DMA_Result_Indices_MUXA[ADC_SEQ_MAX][ADC_SAMP_PER_SEQ_MAX] = \
        {{ADC_ISAMPA, ADC_ISAMPC, ADC_ISAMPD, ADC_TEMP,   ADC_VW},
         {ADC_ISAMPB, ADC_VBUS,   ADC_VPOT,   ADC_VV,     ADC_VU}};

static void* const ADC_Result_Regs_MUXB[ADC_SEQ_MAX][ADC_SAMP_PER_SEQ_MAX] = \
        {{ADC_RESULT_ADDR(ADC_SAMP_IDCLINK_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_IU_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_IW_CHAN_IDX),  ADC_RESULT_ADDR(ADC_SAMP_TEMP_CHAN_IDX),   ADC_SAMP_UNUSED},
         {ADC_RESULT_ADDR(ADC_SAMP_IDCLINK_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_IV_CHAN_IDX), ADC_RESULT_ADDR(ADC_SAMP_VBUS_CHAN_IDX),  ADC_RESULT_ADDR(ADC_SAMP_VPOT_CHAN_IDX),   ADC_SAMP_UNUSED}};

static const uint8_t DMA_Result_Indices_MUXB[ADC_SEQ_MAX][ADC_SAMP_PER_SEQ_MAX] = \
        {{ADC_ISAMPA, ADC_ISAMPC, ADC_ISAMPD, ADC_TEMP, ADC_VV},
         {ADC_ISAMPB, ADC_VU,     ADC_VBUS,   ADC_VPOT, ADC_VW}};
