...
# configurations.
TARGET=REF_MTR_48V_PSOCC3_GAN

# Name of application (used to derive name of final linked file).
#
# If APPNAME is edited, ensure to update or regenerate launch
# configurations for your IDE.
APPNAME=mtb-example-ce243361-ref_mtr_48v30a_psc3_gan
...
DEFINES+=MOTOR_CTRL_ENABLE_DC_CHOPPER
...
CY_IGNORE+=$(wildcard ../mtb_shared/motor-ctrl-lib/*/OperationalCode/BlockComm.c ../mtb_shared/motor-ctrl-lib/*/OperationalCode/StateMachine.c)
...
# BSP linker script maps RAM code and data into one RWX segment; binutils 2.39+ warns about it.
